...
def make_estimator(method='RF', n_estimators = 200, random_state = 0,predictors = 'forest'):
    if method == 'RF':
        return RandomForestRegressor(n_estimators = n_estimators, random_state= random_state,max_features = "sqrt")
        ...
        return ExtraTreesRegressor(n_estimators = n_estimators, random_state= random_state,max_features = "sqrt")
